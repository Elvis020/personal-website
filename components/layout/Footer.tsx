...
// Icon component that's bigger on mobile
...
const socialLinks = [
  {
    href: "https://github.com/Elvis020",
    label: "GitHub",
  ...
  {
    href: "https://x.com/spacewalker13",
    label: "X",
    path: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z",
  },
  {
    href: "https://www.linkedin.com/in/elvis-opoku-amoako-3b1896a9",
    label: "LinkedIn",
